...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["api.shipmate.com"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="ShipMate <noreply@api.shipmate.com>",
)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = CD_EMAIL
EMAIL_HOST_PASSWORD = CD_EMAIL_PASSWORD
DEFAULT_FROM_EMAIL = CD_EMAIL
