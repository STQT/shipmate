...
urlpatterns = [
    ...
    path('marks/<int:pk>/create/', CreateCarMarksAPIView.as_view(), name='car-marks-create'),
    ...
    path('models/<int:pk>/create/', CreateCarsModelAPIView.as_view(), name='car-models-create'),
]
