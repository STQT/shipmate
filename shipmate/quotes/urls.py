...
urlpatterns = [
    ...
    path('<str:guid>/update/', UpdateQuoteAPIView.as_view(), name='quote-update'),
    path('<str:guid>/detail/', DetailQuoteAPIView.as_view(), name='quote-detail'),
    path('<str:guid>/delete/', DeleteQuoteAPIView.as_view(), name='quote-delete'),
]
